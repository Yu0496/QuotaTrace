...
一款专为 **OpenAI Codex** 与 **Google Antigravity** 开发者打造的本地轻量用量监控与额度测算小助手。
...
**零外网出站请求 · 零隐私上传 · 毫秒级增量 · 纯本机解析与进程通信**
...
QuotaTrace 提供三种渐进式的交互形态，从日常无感常驻到多维度深度分析：
...
└────────────┬────────────────────────────┬───────────────┘
             ...
             ▼                            ▼
┌─────────────────────────┐  ┌────────────────────────────┐
│ 1. 托盘悬浮提示 (Tooltip)│  │ 2. 单击小面板 (Popup Card) │
└────────────┬────────────┘  └────────────┬───────────────┘
             │                            │ 双击托盘唤起
             └─────────────┬──────────────┘
                           ▼
